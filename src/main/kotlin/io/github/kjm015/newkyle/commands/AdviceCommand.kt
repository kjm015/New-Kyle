...
/**
 * This command will let Kyle give you advice should you ask for it. Again, it's mostly utter
 * garbage. It's the thought that counts.
 *
 * @author kjm015
 * @since 7/26/2018
 */
...
class AdviceCommand : Command() {
   ...
   *
   * For this class, Kyle gives advices that is formatted based on things from both this class and
   * the MessageGenerator class [io.github.kjm015.newkyle.util.MessageGenerator]
   *
   * @param event
