...
/**
 * This command will make Kyle pull a quote from the QuoteGenerator class. For right now, the only
 * thing in there is Skyrim. We'll work on adding more stuff to this later.
 *
 * @author kjm015
 * @since 1/20/2019
 */
...
class QuoteCommand(private val quotes: QuotesGenerator) : Command() {
  ...
  override fun execute(event: CommandEvent) {
    ...
    } else if (event.args.contains("Rolf", ignoreCase = true) ||
        event.args.contains("edd", ignoreCase = true)) {
