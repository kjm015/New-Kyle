...
import io.github.kjm015.newkyle.util.withoutAbout
import java.util.*
import org.springframework.stereotype.Component

/**
 * This command is to allow Kyle to ramble about whatever is on his mind at any given moment. It
 * usually generates nonsensical garbage, you can add more util templates if you feel like it.
 *
 * @author kjm015
 * @since 7/26/2018
 */
...
class RambleCommand(private val generator: MessageGenerator) : Command() {
   ...
   *
   * For this class, Kyle will respond to the command with some absolute garbage util as per the
   * [io.github.kjm015.newkyle.util.MessageGenerator] class
   *
   * @param event
   ...
   *
   * @param args
   * - the arguments to be passed into the util formatter
