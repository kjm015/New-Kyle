...
/**
 * This class is a listener for when Kyle gets direct messaged or mentioned. Whenever a message is
 * sent in any channel that Kyle can see, this class and the method onMessageReceived get called.
 *
 * @author kjm015
 * @since 1/6/2019
 */
  ...
  override fun onMessageReceived(event: MessageReceivedEvent) {
    ...
    if (event.message.contentDisplay.contains(AppConstants.FLAG_TERM_1, ignoreCase = true)) {
      ...
      event.message.channel
          .sendMessage("This is Felix. Felix is an idiot. Don't be like Felix.")
          .queue()
    }
