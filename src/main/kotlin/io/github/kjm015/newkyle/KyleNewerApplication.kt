 ...
 *
 * This is where the application gets ran, and where all of the commands are imported. This is where
 * all of the beans are created and where the settings for each instance of the bot are put into
 * place.
 *
